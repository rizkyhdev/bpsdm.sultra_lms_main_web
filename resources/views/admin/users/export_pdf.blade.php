...
<head>
    <meta charset="utf-8">
    <title>Rekapitulasi Pengguna</title>
    <style>
        body {
    ...
    <table>
        <thead>
            <tr>
                ...
                <th width="10%" class="text-center">Tervalidasi</th>
                <th width="15%" class="text-center">Kursus Selesai</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{ $user->is_validated ? 'Ya' : 'Belum' }}</td>
                <td class="text-center">{{ $user->completed_courses_count ?? 0 }}</td>
            </tr>
            @empty
            <tr>
                <td colspan="7" class="text-center" style="padding: 20px;">Tidak ada data pengguna yang ditemukan.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
