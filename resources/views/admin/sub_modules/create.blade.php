...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item"><a href="{{ route('admin.modules.show', request('module')) }}">Modul</a></li>
    <li class="breadcrumb-item active">Tambah Sub Modul</li>
@endsection

@section('content')
    <div class="card shadow-sm">
        <div class="card-body">
            <form action="{{ route('admin.sub_modules.store') }}" method="POST">
                @csrf
                <input type="hidden" name="module_id" value="{{ request('module') ?? ($module->id ?? '') }}">
                <div class="form-row">
                ...
                <div class="d-flex justify-content-between">
                    <a href="{{ route('admin.modules.show', request('module') ?? ($module->id ?? 0)) }}" class="btn btn-outline-secondary">Kembali</a>
