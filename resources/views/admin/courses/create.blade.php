            ...
            <form action="{{ route('admin.courses.store') }}" method="POST">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" id="jp_value" name="jp_value" value="{{ old('jp_value') }}" class="form-control @error('jp_value') is-invalid @enderror">
                        @error('jp_value')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group col-md-3">
                        <label for="bidang_kompetensi">Bidang Kompetensi</label>
                        <input type="text" id="bidang_kompetensi" name="bidang_kompetensi" value="{{ old('bidang_kompetensi') }}" class="form-control @error('bidang_kompetensi') is-invalid @enderror">
