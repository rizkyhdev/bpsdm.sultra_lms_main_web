    ...
    <div class="card-body">
      <form class="form-inline" method="get" action="{{ route('instructor.courses.index') }}">
        ...
        @can('create', App\Models\Course::class)
          <a href="{{ route('instructor.courses.create') }}" class="btn btn-success mb-2 ml-2">Buat Pelatihan</a>
        ...
        <tbody>
          @forelse($courses as $course)
            <tr>
              ...
              <td class="text-right">
                <a class="btn btn-sm btn-outline-primary" href="{{ route('instructor.courses.show', $course->id) }}">Lihat</a>
                <!-- @can('update', $course)
