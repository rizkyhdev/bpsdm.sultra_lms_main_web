        ...
        <div class="wizard-step" id="step1">
          ...
          <div class="row">
            <div class="col-md-6 mb-3">
              ...
              <input type="datetime-local" name="start_date_time" value="{{ old('start_date_time') }}" class="form-control">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input type="datetime-local" name="end_date_time" value="{{ old('end_date_time') }}" class="form-control">
