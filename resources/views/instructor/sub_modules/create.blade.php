...
<div class="container-fluid">
  <div class="card">
    <div class="card-header bg-primary text-white">
      <h5 class="mb-0">Sub-Module Creation Wizard</h5>
      <small>Buat sub-module lengkap dengan contents dalam satu alur</small>
    </div>
    <div class="card-body">
      @if(session('error'))
      ...
      <form action="{{ route('instructor.sub_modules.store', $module->id) }}" method="post" enctype="multipart/form-data" id="subModuleWizardForm">
        @csrf
        ...
        <div class="wizard-step" id="step1">
          ...
          <div class="d-flex justify-content-end mt-4">
            <button type="button" class="btn btn-primary" onclick="nextStep(2)">Next: Add Contents →</button>
          </div>
        </div>
        ...
        <div class="wizard-step" id="step2" style="display: none;">
          ...
          <p class="text-muted mb-4">Tambahkan contents untuk sub-module ini (opsional).</p>
        ...
        <div class="wizard-step" id="step3" style="display: none;">
          ...
          <div class="d-flex justify-content-between mt-4">
            ...
            <button type="submit" class="btn btn-success">
              <i class="bi bi-check-circle"></i> Create Sub-Module
            </button>
          </div>
        </div>
      </form>
...
function updateReview() {
  ...
  if (contents.length === 0) {
    ...
    contents.forEach((content, idx) => {
      ...
      contentDiv.innerHTML = `<strong>Content ${idx + 1}:</strong> ${judul} (${tipe})`;
