@extends('layouts.studentapp') <!-- Sesuaikan dengan layout kamu -->
...
<div class="container-fluid my-1">
  ...
  <div style="background-color: #21b3ca;" class="p-2 rounded-bottom">
    <ul class="nav nav-tabs border-0 mt-2" id="coursesTab">
      <li class="nav-item">
        <a class="nav-link btn-outline-info text-white fw-semibold px-4 rounded me-4" href="{{ route('enrolled') }}" data-tab="enrolled">Pelatihan yang diikuti</a>
      </li>
      <li class="nav-item">
        <a class="nav-link active btn-outline-info text-dark fw-semibold px-4 rounded me-4" href="{{ route('active') }}" data-tab="active">Pelatihan yang Aktif</a>
      </li>
      <li class="nav-item">
  ...
  <!-- Course Cards -->
    <div class="container-fluid my-4 px-1">
      <div class="row justify-content g-4">
        <!-- Card 1 -->
        <div class="col-auto">
          <a href="halaman1.html" class="text-decoration-none">
        ...
        <!-- Card 2 -->
        <div class="col-auto">
          <a href="halaman2.html" class="text-decoration-none">
            <div class="card shadow border-0 h-100 hover-card"
                style="width:230px; border-radius:22px; overflow:hidden; cursor:pointer;">
              <div class="text-white d-flex align-items-center" 
